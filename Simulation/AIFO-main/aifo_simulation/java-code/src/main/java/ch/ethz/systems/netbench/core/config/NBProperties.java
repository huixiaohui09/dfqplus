...
public class NBProperties extends Properties {
    ...
    private void initializeAllowedProperties(String[]... additionalAllowedProperties) {
        // ================= Core / Common =================
        allowedProperties.add("scenario_topology_file");
        allowedProperties.add("run_time_s");
        allowedProperties.add("seed");

        // Run management / analysis
        allowedProperties.add("run_folder_name");
        allowedProperties.add("run_folder_base_dir");
        allowedProperties.add("analysis_command");

        // ================= Transport =================
        allowedProperties.add("transport_layer");

        // ================= Device / Routing / Intermediary =================
        allowedProperties.add("network_device");
        allowedProperties.add("network_device_routing");
        allowedProperties.add("network_device_intermediary");

        // ================= Output Port (DFQ etc.) =================
        allowedProperties.add("output_port");
        allowedProperties.add("output_port_number_queues");
        allowedProperties.add("output_port_max_size_per_queue_packets");
        allowedProperties.add("output_port_max_queue_size_bytes");
        allowedProperties.add("output_port_bytes_per_round");
        allowedProperties.add("window_size");

        // ================= Link =================
        allowedProperties.add("link");
        allowedProperties.add("link_delay_ns");
        allowedProperties.add("link_bandwidth_bit_per_ns");

        // ================= Traffic (common) =================
        allowedProperties.add("traffic");
        allowedProperties.add("traffic_flow_size_dist");
        allowedProperties.add("traffic_probabilities_generator");
        allowedProperties.add("traffic_probabilities_file");

        // Poisson arrival
        allowedProperties.add("traffic_lambda_flow_starts_per_s");

        // ================= Fixed / Pair / List (kept for compatibility) =================
        allowedProperties.add("traffic_total_flows");
        allowedProperties.add("traffic_flow_size_byte");
        allowedProperties.add("traffic_interarrival_ns");

        allowedProperties.add("traffic_pair_type");
        allowedProperties.add("traffic_pair_flow_size_byte");
        allowedProperties.add("traffic_pair_stride");
        allowedProperties.add("traffic_pairs");

        allowedProperties.add("traffic_arrivals_list");

        // ================= Flow size distributions (params) =================
        allowedProperties.add("traffic_flow_size_dist_pareto_shape");
        allowedProperties.add("traffic_flow_size_dist_pareto_mean_kilobytes");
        allowedProperties.add("traffic_flow_size_dist_uniform_mean_bytes");

        // ================= Burst traffic (NEW) =================
        // For burst_flow traffic generator
        allowedProperties.add("traffic_burst_mode");          // "periodic" or "random"
        allowedProperties.add("traffic_burst_interval_ns");  
        allowedProperties.add("traffic_burst_duration_ns"); 
        allowedProperties.add("traffic_window_flows");       
        allowedProperties.add("traffic_window_duration_ns"); 

        // Additional properties from outside
