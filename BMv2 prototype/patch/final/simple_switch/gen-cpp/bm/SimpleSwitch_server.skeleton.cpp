...
class SimpleSwitchHandler : virtual public SimpleSwitchIf {
 public:
  ...
  int32_t set_egress_priority_queue_depth(const int32_t port_num, const int32_t priority, const int32_t depth_pkts) {
    // Your implementation goes here
    printf("set_egress_priority_queue_depth\n");
  }
  ...
  int32_t set_egress_priority_queue_rate(const int32_t port_num, const int32_t priority, const int64_t rate_pps) {
    // Your implementation goes here
    printf("set_egress_priority_queue_rate\n");
  }
...
int main(int argc, char **argv) {
  int port = 9090;
  ::std::shared_ptr<SimpleSwitchHandler> handler(new SimpleSwitchHandler());
  ::std::shared_ptr<TProcessor> processor(new SimpleSwitchProcessor(handler));
