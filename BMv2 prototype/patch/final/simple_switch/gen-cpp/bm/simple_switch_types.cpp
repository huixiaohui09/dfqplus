...
const std::map<int, const char*> _MirroringOperationErrorCode_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(1, _kMirroringOperationErrorCodeValues, _kMirroringOperationErrorCodeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
MirroringSessionConfig::~MirroringSessionConfig() noexcept {
}
...
MirroringSessionConfig::MirroringSessionConfig(const MirroringSessionConfig& other0) noexcept {
  port = other0.port;
  mgid = other0.mgid;
  __isset = other0.__isset;
}
MirroringSessionConfig& MirroringSessionConfig::operator=(const MirroringSessionConfig& other1) noexcept {
  port = other1.port;
  mgid = other1.mgid;
...
InvalidMirroringOperation::~InvalidMirroringOperation() noexcept {
}
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->code = static_cast<MirroringOperationErrorCode::type>(ecast2);
...
InvalidMirroringOperation::InvalidMirroringOperation(const InvalidMirroringOperation& other3) noexcept : TException() {
  code = other3.code;
  __isset = other3.__isset;
}
InvalidMirroringOperation& InvalidMirroringOperation::operator=(const InvalidMirroringOperation& other4) noexcept {
  code = other4.code;
...
const char* InvalidMirroringOperation::what() const noexcept {
  try {
    std::stringstream ss;
